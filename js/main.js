...
let track_list = [
    {
        name: "The Beginning",
        artist: "The Long Gone",
        image: "https://source.unsplash.com/1uVCTVSn-2o",
        path: "the-long-gone_the-beginning.mp3"
    },
    {
        name: "Sweet William",
        artist: "The Long Gone",
        image: "https://source.unsplash.com/aX9KlIQlrVE",
        path: "the-long-gone_sweet-william.mp3"
    }
];
...
function random_bg_color() {
    ...
    let bgColor = `linear-gradient(to bottom right,${getRandomHEXColor()},${getRandomHEXColor()})`;

    // Set the background to the new color
    document.getElementById("sounds").style.background = bgColor;
}
